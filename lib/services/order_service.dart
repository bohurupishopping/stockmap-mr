...
class OrderService {
  ...
  static Future<String> createMrSalesOrder({
    ...
    try {
      log('OrderService: Starting createMrSalesOrder');
      ...
      log('OrderService: Creating order for user $userId with ${items.length} items, total: $totalAmount');
      ...
      log('OrderService: Items data: $itemsData');
      ...
      log('OrderService: RPC response: $response');
      ...
      log('OrderService: Order created successfully with ID: $orderId');
  ...
  static Future<Map<String, dynamic>> validateStockAvailability(
    ...
    try {
      log('OrderService: Validating stock availability for ${cartItems.length} items');
      
      final stockItems = await getMrStock();
      ...
      log('OrderService: Error validating stock: $e');
